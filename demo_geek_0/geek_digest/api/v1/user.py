...
from geek_digest.service.user import save_new_user, update_user, delete_user
...
class UserAPI(BaseAPI):
    ...
    def delete(self, id=None):
        ...
        if user and current_user.is_admin:
            user.delete()
            return util.api_response(data={'msg': 'The user deleted.'})
        else:
            raise ValueError('Donnot have authority.')